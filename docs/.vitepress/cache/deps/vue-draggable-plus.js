...
// node_modules/.pnpm/vue-draggable-plus@0.6.1_@types+sortablejs@1.15.9/node_modules/vue-draggable-plus/dist/vue-draggable-plus.js
var an = Object.defineProperty;
var Pe = Object.getOwnPropertySymbols;
var yt = Object.prototype.hasOwnProperty;
var wt = Object.prototype.propertyIsEnumerable;
var bt = (t, e, n) => e in t ? an(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
var fe = (t, e) => {
  for (var n in e || (e = {}))
...
function ht(t, e) {
  for (var n = t.lastElementChild; n && (n === p.ghost || h2(n, "display") === "none" || e && !We(n, e)); )
  ...
  return {
    ...
    animate: function(o, r, i, a) {
      if (a) {
        ...
        o.animatingX = !!d, o.animatingY = !!f, h2(o, "transform", "translate3d(" + d + "px," + f + "px,0)"), this.forRepaintDummy = Yn(o), h2(o, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), h2(o, "transform", "translate3d(0,0,0)"), typeof o.animated == "number" && clearTimeout(o.animated), o.animated = setTimeout(function() {
...
var Kt = function(e, n) {
  var o = h2(e), r = parseInt(o.width) - parseInt(o.paddingLeft) - parseInt(o.paddingRight) - parseInt(o.borderLeftWidth) - parseInt(o.borderRightWidth), i = we(e, 0, n), a = we(e, 1, n), l = i && h2(i), s = a && h2(a), u = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + P(i).width, d = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + P(a).width;
  if (o.display === "flex")
...
p.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTouchMove: function(e) {
    if (de) {
      ...
      if (g) {
        ...
        h2(g, "webkitTransform", m), h2(g, "mozTransform", m), h2(g, "msTransform", m), h2(g, "transform", m), Qe = d, et = f, Z = i;
      }
  ...
  _onDragStart: function(e, n) {
    ...
    }), !n && V(c, i.dragClass, true), n ? (Ge = true, o._loopId = setInterval(o._emulateDragOver, 50)) : (E(document, "mouseup", o._onDrop), E(document, "touchend", o._onDrop), E(document, "touchcancel", o._onDrop), r && (r.effectAllowed = "move", i.setData && i.setData.call(o, r, c)), S(document, "drop", o), h2(c, "transform", "translateZ(0)")), ve = true, o._dragStartId = He(o._dragStarted.bind(o, n, e)), S(document, "selectstart", o), Se = true, Te && h2(document.body, "user-select", "none");
  },
  ...
  _hideClone: function() {
    if (!ue) {
      if (z("hideClone", this), p.eventCanceled)
        return;
      h2(C, "display", "none"), this.options.removeCloneOnHide && C.parentNode && C.parentNode.removeChild(C), ue = true;
    }
  },
  _showClone: function(e) {
    ...
    if (ue) {
      if (z("showClone", this), p.eventCanceled)
        return;
      c.parentNode == T && !this.options.group.revertClone ? T.insertBefore(C, c) : pe ? T.insertBefore(C, pe) : T.appendChild(C), this.options.group.revertClone && this.animate(c, C), h2(C, "display", ""), ue = false;
    }
  }
};
function zn(t) {
...
var it = zt(function(t, e, n, o) {
  if (e.scroll) {
    ...
    var f = 0, m = De;
    do {
      var y = m, b = P(y), w = b.top, L = b.bottom, G = b.left, R = b.right, j = b.width, B = b.height, X = void 0, K = void 0, oe = y.scrollWidth, le = y.scrollHeight, k = h2(y), v = y.scrollLeft, D = y.scrollTop;
...
var so = {
  [Bt.mounted](t, e) {
    const n = isProxy(e.value) ? [e.value] : e.value, [o, r] = n, i = on(t, o, r);
    at.set(t, i.destroy);
  },
  [Bt.unmounted](t) {
    var e;
